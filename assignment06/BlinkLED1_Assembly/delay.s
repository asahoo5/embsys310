...
delay
    ...
    B.N COMPARE                // Jump to @Compare
    COMPARE: 
               CMP R0, R1      // Compare with R0 with R1
               BEQ RETURN      // If not equal, Branch to decrement R0 content | else, return to calling function
               SUBS R0, R0, #1 // decrement the content of R0 by 1 
               B COMPARE       // Branch to Compare loop
    RETURN:    BX LR           // Return to Calling Function
    END
